...
st.set_page_config(page_title="AI好友圈文案生成器", page_icon="🌸")
st.title("🌸 AI 好友圈文案生成器")

# 在侧边栏让用户输入自己的挂钩，保护你的钱包
with st.sidebar:
    st.title("🔒 安全设置")
    user_api_key = st.text_input("输入 DeepSeek API 密钥", type="password")
    st.info("💡如果你想免费给别人用，也可以在这里写死你的钥匙，但风险自担哦！")
